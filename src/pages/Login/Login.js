                    ...
                    <div className='w-full md:w-3/4 mx-auto flex items-center'>
                        <div className="card flex-shrink-0 w-full shadow-2xl bg-base-100">
                            <div className="card-body px-5 md:px-8">
                                <h2 className='text-center font-semibold text-2xl py-1'>Log in to WareHouse</h2>
                                ...
                                <div className="form-control">
                                    ...
                                    <label className="label">
                                        <Link to='/Forgotpassword' className=" font-medium text-base text-red-700">Forgot password?</Link>
                                    </label>
                                </div>
                                ...
                                <label className="label">
                                    <p className='font-medium text-base'>New to WareHouse?
                                        <Link to='/registration' className="ml-2 text-red-700">Register Now</Link>
                                    </p>
