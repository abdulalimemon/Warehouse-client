...
import InventoryLoading from '../Shared/InventoryLoading';
import InventoryItem from './InventoryItem';

const Inventory = () => {
    const [inventorys, setInventorys, isLoading, setIsLoading] = useInventory();
            ...
            <div className='bgBodyPrimary'>
                <div className='container mx-auto pt-8 pb-16 lg:pt-16 lg:pb-20'>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-10'>
                        {isLoading && <InventoryLoading cards={6}></InventoryLoading>}
                        {
